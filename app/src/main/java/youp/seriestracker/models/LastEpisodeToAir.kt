...
class LastEpisodeToAir : Parcelable {
    ...
    protected constructor(`in`: Parcel) {
        ...
        this.stillPath = `in`.readValue(String::class.java.classLoader) as String
    ...
    companion object {
        val CREATOR: Parcelable.Creator<LastEpisodeToAir> = object : Creator<LastEpisodeToAir> {


            override fun createFromParcel(`in`: Parcel): LastEpisodeToAir {
                return LastEpisodeToAir(`in`)
            }
